...
pub const _c_REVLib_ErrorCode_c_REVLibError_SparkFlexBrushedWithoutDock: _c_REVLib_ErrorCode = 21;
pub const _c_REVLib_ErrorCode_c_REVLibError_NumCodes: _c_REVLib_ErrorCode = 22;
...
pub const c_SparkMax_kAPIMajorVersion: u16 = 2024;
pub const c_SparkMax_kAPIMinorVersion: u8 = 2;
pub const c_SparkMax_kAPIBuildVersion: u8 = 4;
pub const c_SparkMax_kAPIVersion: u32 = 132645380;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const c_SparkMax_SparkModel_c_SparkMax_SparkMax: c_SparkMax_SparkModel = 0;
pub const c_SparkMax_SparkModel_c_SparkMax_SparkFlex: c_SparkMax_SparkModel = 1;
pub const c_SparkMax_SparkModel_c_SparkMax_Unknown: c_SparkMax_SparkModel = 255;
pub type c_SparkMax_SparkModel = ::std::os::raw::c_uint;
...
pub const c_SparkMax_ConfigParameter_c_SparkMax_kDutyCycleZeroCentered: c_SparkMax_ConfigParameter =
    152;
pub const c_SparkMax_ConfigParameter_c_SparkMax_kDutyCyclePrescaler: c_SparkMax_ConfigParameter =
    153;
pub const c_SparkMax_ConfigParameter_c_SparkMax_kDutyCycleOffset: c_SparkMax_ConfigParameter = 154;
pub const c_SparkMax_ConfigParameter_c_SparkMax_kProductId: c_SparkMax_ConfigParameter = 155;
pub const c_SparkMax_ConfigParameter_c_SparkMax_kDeviceMajorVersion: c_SparkMax_ConfigParameter =
    156;
pub const c_SparkMax_ConfigParameter_c_SparkMax_kDeviceMinorVersion: c_SparkMax_ConfigParameter =
    157;
pub const c_SparkMax_ConfigParameter_c_SparkMax_NumParameters: c_SparkMax_ConfigParameter = 158;
...
pub const c_SparkMax_PeriodicFrame_c_SparkMax_kStatus7: c_SparkMax_PeriodicFrame = 7;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct c_SparkMax_PeriodicStatus7 {
    pub iAccum: f32,
    pub timestamp: u64,
}
#[test]
fn bindgen_test_layout_c_SparkMax_PeriodicStatus7() {
    const UNINIT: ::std::mem::MaybeUninit<c_SparkMax_PeriodicStatus7> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<c_SparkMax_PeriodicStatus7>(),
        16usize,
        concat!("Size of: ", stringify!(c_SparkMax_PeriodicStatus7))
    );
    assert_eq!(
        ::std::mem::align_of::<c_SparkMax_PeriodicStatus7>(),
        8usize,
        concat!("Alignment of ", stringify!(c_SparkMax_PeriodicStatus7))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(c_SparkMax_PeriodicStatus7),
            "::",
            stringify!(iAccum)
        )
    );
...
extern "C" {
    pub fn c_SparkMax_SetPeriodicFrameTimeout(
        handle: c_SparkMax_handle,
        timeoutMs: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn c_SparkMax_SetCANMaxRetries(
        handle: c_SparkMax_handle,
        numRetries: ::std::os::raw::c_int,
    );
}
extern "C" {
